// components/gameInterfaces/BasketBall/ThreeWayGameCard.tsx
import React, { useState } from 'react';
import { View, Text, Pressable, StyleSheet } from 'react-native';
import { Match } from '@/interface';

interface ThreeWayGameCardProps {
  match: Match;
}

const ThreeWayGameCard: React.FC<ThreeWayGameCardProps> = ({ match }) => {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.oddsContainer}>
          ...
          {/* Draw */}
          <Pressable
            style={[styles.oddsButton, selected === 'draw' && styles.activeOdd]}
            onPress={() => setSelected('draw')}
          >
            <Text style={[styles.oddsText, selected === 'draw' && styles.activeText]}>
              {match.odds?.draw ?? '-'}
            </Text>
          </Pressable>
...
export default ThreeWayGameCard;
